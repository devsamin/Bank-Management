...
# 🌐 Allowed hosts for your deployed domain
ALLOWED_HOSTS = [
    "bank-management-r8c6.onrender.com",
    "bank-management-2.onrender.com",
    "127.0.0.1",
    "localhost"
]

# 🛡 CSRF trusted origins (MUST include full https://)
CSRF_TRUSTED_ORIGINS = [
    "https://bank-management-r8c6.onrender.com",
    "https://bank-management-2.onrender.com"
]
...
# ✅ Database (Use SQLite for local, PostgreSQL for Render)
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://your_user:your_pass@your_host:5432/your_db',
        conn_max_age=600,
        ssl_require=True
    )
}
